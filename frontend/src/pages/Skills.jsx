...
const concepts = [
  ...
  'Effective Communication', 'Version Control',
]
...
function SkillCard({ group, i }) {
  ...
  return (
    <motion.div
      ...
      className="p-6 border glass rounded-2xl border-border card-hover"
    >
      ...
      <main className="pb-16 pt-28">
        <div className="max-w-6xl px-6 mx-auto">
          ...
          <motion.div
            ...
            className="p-8 border glass rounded-2xl border-border"
          >
            <h3 className="flex items-center gap-2 mb-6 text-lg font-bold text-white font-display">
            ...
            <div className="flex flex-wrap gap-3">
              {concepts.map((c, i) => (
                <motion.span
                  ...
                  className="px-4 py-2 font-mono text-sm text-gray-300 transition-all border cursor-default rounded-xl bg-white/5 border-border hover:border-accent/30 hover:text-accent hover:bg-accent/5"
                >
                  {c}
                </motion.span>
              ))}
